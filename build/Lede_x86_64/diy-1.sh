...
git clone https://github.com/garypang13/openwrt-packages/tree/master/lua-maxminddb.git package/diycj/bypassyl
git clone https://github.com/garypang13/openwrt-packages/tree/master/smartdns-le.git package/diycj/bypassyl
